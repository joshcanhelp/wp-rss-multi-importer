...
name="rssmi_url"
value="<?php echo $rssmi_url; ?>" /><?php if (isset($rssmi_url) && $rssmi_url!=''){echo 'Validate this feed source URL by <a href="http://feedvalidator.org/check?url='.$rssmi_url.'" target="_blank">clicking here</a>';}?></td>
</tr>
<tr>
...
<tr>
	...
	<td>	
		...
		for ($i = 1 ; $i<=5;$i++){
			...
			<?php echo $i; ?> 
		<?php	} ?>
			</select> (for Media Image - selects which media image in the feed's image enclosure.  If you choose an image number, this will be used over any other image found.  <a href="http://www.wprssimporter.com/faqs/what-is-the-media-image-number/" target="_blank">Learn more about this here.</a>)
</td>
</tr>
